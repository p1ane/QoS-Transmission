function [H_freq,H_freq_beam,CCM] = gen_of_evchannel(~)
addpath('.\SCM');
j = sqrt(-1);
% Basic Parameters
% system parameters
...
NumUsers = 1;               % number of users in the cell and one passive eavesdrropper
NumSamples = 2000;         % number of samples in each channel realization
%NumSamples_ergosimu = 1000;  % number of samples in ergodic simulation
